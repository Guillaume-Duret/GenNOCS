...
for fruit in "${fruits[@]}"; do
    sbatch fix_only_texture.slurm "/lustre/fsn1/projects/rech/tya/ubn15wo/3D_GEN/Fruits_data/" "${fruit}" "/lustre/fswork/projects/rech/tya/ubn15wo/3D_gen/3DMeshes_Generation/Slurm/script_deepsdf/"
done

# Loop over vegetables and submit sbatch commands
for vegetable in "${vegetables[@]}"; do
    sbatch fix_only_texture.slurm "/lustre/fsn1/projects/rech/tya/ubn15wo/3D_GEN/Vegetables_data/" "${vegetable}" "/lustre/fswork/projects/rech/tya/ubn15wo/3D_gen/3DMeshes_Generation/Slurm/script_deepsdf/"
done
