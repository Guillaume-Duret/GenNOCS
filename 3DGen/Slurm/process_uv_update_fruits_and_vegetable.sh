...
for fruit in "${fruits[@]}"; do
    sbatch process_uv_generated_meshes.slurm "/lustre/fsn1/projects/rech/tya/ubn15wo/3D_GEN/Fruits_data/" "${fruit}"
done

# Loop over vegetables and submit sbatch commands
for vegetable in "${vegetables[@]}"; do
    sbatch process_uv_generated_meshes.slurm "/lustre/fsn1/projects/rech/tya/ubn15wo/3D_GEN/Vegetables_data/" "${vegetable}"
done
