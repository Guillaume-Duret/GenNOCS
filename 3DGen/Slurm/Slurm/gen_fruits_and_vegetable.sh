...
#for fruit in "${fruits[@]}"; do
    sbatch generate_images_and_meshes.slurm "/lustre/fswork/projects/rech/tya/ubn15wo/3D_gen/3DMeshes_Generation/prompt/fruits_final/${fruit}.txt" "/lustre/fsn1/projects/rech/tya/ubn15wo/Final_3D_GEN/Fruits_data/" "${fruit}"
#done

# Loop over vegetables and submit sbatch commands
for vegetable in "${vegetables[@]}"; do
    sbatch generate_images_and_meshes.slurm "/lustre/fswork/projects/rech/tya/ubn15wo/3D_gen/3DMeshes_Generation/prompt/vegetables_final/${vegetable}.txt" "/lustre/fsn1/projects/rech/tya/ubn15wo/Final_3D_GEN/Vegetables_data/" "${vegetable}"
done
